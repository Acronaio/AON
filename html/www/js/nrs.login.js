...
var NRS = (function(NRS, $, undefined) {
	...
	NRS.initPluginWarning = function() {
		if (NRS.activePlugins) {
			...
			html += "Plugins are not sandboxed or restricted in any way and have full accesss to your client system including your AON passphrase.";
			html += "</p>";
			...
			html += "you can loose your AON! In doubt don't run plugins with accounts ";
