...
var NRS = (function (NRS, $) {
    NRS.constants = {
        ...
        'UNKNOWN': 'unknown',
        'LAST_KNOWN_BLOCK': { id: "1243276750460020887", height: "0" },
        'LAST_KNOWN_TESTNET_BLOCK': { id: "2680262203532249785", height: "-1" },
    ...
    NRS.loadNews = function(resolve) {
        let xmlHttp = new XMLHttpRequest();
        try {
            xmlHttp.open( "GET", "https://acrona.space/wp-json/wp/v2/posts?page=1&per_page=5&categoryId=2", false );
            xmlHttp.send( null );
            NRS.news = JSON.parse(xmlHttp.responseText);
        } catch(error) {
            NRS.news = {};
            console.error(error);
        }
