...
public final class Nxt {
        ...
        try {
            ...
            if (configFile != null) {
                ...
                try (InputStream is = ClassLoader.getSystemResourceAsStream(propertiesFile)) {
                    ...
                    // TODO: uncomment if necessary, seems like not really
    ...
    private static class Init {
        ...
        static {
            try {
                //Loading custom config if present
                String configPath = System.getenv("JELLY_CONFIG");

                if (configPath != null) {
                    loadProperties(properties, configPath, false);
                }
