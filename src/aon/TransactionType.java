...
import aon.Account.ControlType;
import aon.AccountLedger.LedgerEvent;
import aon.Attachment.AbstractAttachment;
import aon.NxtException.ValidationException;
import aon.VoteWeighting.VotingModel;
...
public abstract class TransactionType {
    ...
    public static abstract class Messaging extends TransactionType {
        ...
        public final static TransactionType ARBITRARY_MESSAGE = new Messaging() {
            ...
            void validateAttachment(Transaction transaction) throws NxtException.ValidationException {
                ...
                if (transaction.getRecipientId() == Genesis.CREATOR_ID && AON.getBlockchain().getHeight() > Constants.MONETARY_SYSTEM_BLOCK) {
        ...
        public static final TransactionType ALIAS_ASSIGNMENT = new Messaging() {
            ...
            private final Fee ALIAS_FEE = new Fee.SizeBasedFee(2 * Constants.ONE_AON * Constants.FEE_MULTIPLIER, 2 * Constants.ONE_AON * Constants.FEE_MULTIPLIER, 32) {
                @Override
            ...
            @Override
            boolean isBlockDuplicate(Transaction transaction, Map<TransactionType, Map<String, Integer>> duplicates) {
                return AON.getBlockchain().getHeight() > Constants.SHUFFLING_BLOCK
        ...
        public final static TransactionType POLL_CREATION = new Messaging() {
            ...
            private final Fee POLL_OPTIONS_FEE = new Fee.SizeBasedFee(10 * Constants.ONE_AON * Constants.FEE_MULTIPLIER, Constants.ONE_AON * Constants.FEE_MULTIPLIER, 1) {
                @Override
                public int getSize(TransactionImpl transaction, Appendix appendage) {
            ...
            private final Fee POLL_SIZE_FEE = new Fee.SizeBasedFee(0, 2 * Constants.ONE_AON * Constants.FEE_MULTIPLIER, 32) {
                @Override
                public int getSize(TransactionImpl transaction, Appendix appendage) {
        ...
        public static final TransactionType PHASING_VOTE_CASTING = new Messaging() {
            ...
            private final Fee PHASING_VOTE_FEE = (transaction, appendage) -> {
                ...
                return attachment.getTransactionFullHashes().size() * Constants.ONE_AON;
            };
        ...
        public static final TransactionType HUB_ANNOUNCEMENT = new Messaging() {
            ...
            @Override
            void validateAttachment(Transaction transaction) throws NxtException.ValidationException {
                if (AON.getBlockchain().getHeight() < Constants.TRANSPARENT_FORGING_BLOCK_7) {
                    throw new NxtException.NotYetEnabledException("Hub terminal announcement not yet enabled at height " + AON.getBlockchain().getHeight());
                }
                Attachment.MessagingHubAnnouncement attachment = (Attachment.MessagingHubAnnouncement) transaction.getAttachment();
        ...
        public static final Messaging ACCOUNT_INFO = new Messaging() {
            ...
            private final Fee ACCOUNT_INFO_FEE = new Fee.SizeBasedFee(Constants.ONE_AON * Constants.FEE_MULTIPLIER, 2 * Constants.ONE_AON * Constants.FEE_MULTIPLIER, 32) {
                @Override
                public int getSize(TransactionImpl transaction, Appendix appendage) {
        ...
        public static final Messaging ACCOUNT_PROPERTY = new Messaging() {
            ...
            private final Fee ACCOUNT_PROPERTY_FEE = new Fee.SizeBasedFee(Constants.ONE_AON * Constants.FEE_MULTIPLIER, Constants.ONE_AON * Constants.FEE_MULTIPLIER, 32) {
                @Override
                public int getSize(TransactionImpl transaction, Appendix appendage) {
    ...
    public static abstract class ColoredCoins extends TransactionType {
        ...
        public static final TransactionType ASSET_ISSUANCE = new ColoredCoins() {
            ...
            private final Fee SINGLETON_ASSET_FEE = new Fee.SizeBasedFee(Constants.ONE_AON * Constants.FEE_MULTIPLIER, Constants.ONE_AON * Constants.FEE_MULTIPLIER, 32) {
                public int getSize(TransactionImpl transaction, Appendix appendage) {
            ...
            private final Fee ASSET_ISSUANCE_FEE = (transaction, appendage) -> isSingletonIssuance(transaction) ?
                    SINGLETON_ASSET_FEE.getFee(transaction, appendage) : 1000 * Constants.ONE_AON;
        ...
        public static final TransactionType ASSET_TRANSFER = new ColoredCoins() {
            ...
            void validateAttachment(Transaction transaction) throws NxtException.ValidationException {
                ...
                if (FxtDistribution.ardorSnapshotAssets.contains(attachment.getAssetId()) && AON.getBlockchain().getHeight() >= Constants.IGNIS_BLOCK) {
        ...
        public static final TransactionType DIVIDEND_PAYMENT = new ColoredCoins() {
            ...
            void validateAttachment(Transaction transaction) throws NxtException.ValidationException {
                Attachment.ColoredCoinsDividendPayment attachment = (Attachment.ColoredCoinsDividendPayment)transaction.getAttachment();
                if (attachment.getHeight() > AON.getBlockchain().getHeight()) {
                    throw new NxtException.NotCurrentlyValidException("Invalid dividend payment height: " + attachment.getHeight()
                            + ", must not exceed current blockchain height " + AON.getBlockchain().getHeight());
                }
                ...
                Asset asset;
                if (AON.getBlockchain().getHeight() > Constants.SHUFFLING_BLOCK) {
                ...
                if (AON.getBlockchain().getHeight() > Constants.FXT_BLOCK) {
                    AssetDividend lastDividend = AssetDividend.getLastDividend(attachment.getAssetId());
                    if (lastDividend != null && lastDividend.getHeight() > AON.getBlockchain().getHeight() - 60) {
                        throw new NxtException.NotCurrentlyValidException("Last dividend payment for asset " + Long.toUnsignedString(attachment.getAssetId())
                                + " was less than 60 blocks ago at " + lastDividend.getHeight() + ", current height is " + AON.getBlockchain().getHeight()
            ...
            boolean isDuplicate(Transaction transaction, Map<TransactionType, Map<String, Integer>> duplicates) {
                Attachment.ColoredCoinsDividendPayment attachment = (Attachment.ColoredCoinsDividendPayment) transaction.getAttachment();
                return AON.getBlockchain().getHeight() > Constants.FXT_BLOCK &&
    ...
    public static abstract class DigitalGoods extends TransactionType {
        ...
        public static final TransactionType LISTING = new DigitalGoods() {
            ...
            private final Fee DGS_LISTING_FEE = new Fee.SizeBasedFee(2 * Constants.ONE_AON * Constants.FEE_MULTIPLIER, 2 * Constants.ONE_AON * Constants.FEE_MULTIPLIER, 32) {
                @Override
                public int getSize(TransactionImpl transaction, Appendix appendage) {
        ...
        public static final TransactionType PURCHASE = new DigitalGoods() {
            ...
            void doValidateAttachment(Transaction transaction) throws NxtException.ValidationException {
                ...
                if (attachment.getDeliveryDeadlineTimestamp() <= AON.getBlockchain().getLastBlockTimestamp()) {
            ...
            @Override
            boolean isDuplicate(Transaction transaction, Map<TransactionType, Map<String, Integer>> duplicates) {
                if (AON.getBlockchain().getHeight() < Constants.MONETARY_SYSTEM_BLOCK) {
                    return false;
                }
                Attachment.DigitalGoodsPurchase attachment = (Attachment.DigitalGoodsPurchase) transaction.getAttachment();
                // not a bug, uniqueness is based on DigitalGoods.DELISTING
        ...
        public static final TransactionType DELIVERY = new DigitalGoods() {
            ...
            private final Fee DGS_DELIVERY_FEE = new Fee.SizeBasedFee(Constants.ONE_AON * Constants.FEE_MULTIPLIER, 2 * Constants.ONE_AON * Constants.FEE_MULTIPLIER, 32) {
                @Override
                public int getSize(TransactionImpl transaction, Appendix appendage) {
    ...
    public static abstract class AccountControl extends TransactionType {
        ...
        public static final TransactionType EFFECTIVE_BALANCE_LEASING = new AccountControl() {
            ...
            void validateAttachment(Transaction transaction) throws NxtException.ValidationException {
                ...
                if (recipientPublicKey == null && AON.getBlockchain().getHeight() > Constants.PHASING_BLOCK) {
        ...
        public static final TransactionType SET_PHASING_ONLY = new AccountControl() {
            ...
            void validateAttachment(Transaction transaction) throws ValidationException {
                ...
                long maxFeesLimit = (attachment.getPhasingParams().getVoteWeighting().isBalanceIndependent() ? 3 : 22) * Constants.ONE_AON;
                if (maxFees < 0 || (maxFees > 0 && maxFees < maxFeesLimit) || maxFees > Constants.MAX_BALANCE_NQT) {
                    throw new NxtException.NotValidException(String.format("Invalid max fees %f NXT", ((double)maxFees)/Constants.ONE_AON));
                }
    ...
    public static abstract class Data extends TransactionType {
        ...
        private static final Fee TAGGED_DATA_FEE = new Fee.SizeBasedFee(Constants.ONE_AON * Constants.FEE_MULTIPLIER, Constants.ONE_AON / 10) {
            @Override
        ...
        public static final TransactionType TAGGED_DATA_UPLOAD = new Data() {
            ...
            void validateAttachment(Transaction transaction) throws NxtException.ValidationException {
                ...
                if (attachment.getData() == null && AON.getEpochTime() - transaction.getTimestamp() < Constants.MIN_PRUNABLE_LIFETIME) {
        ...
        public static final TransactionType TAGGED_DATA_EXTEND = new Data() {
            ...
            void validateAttachment(Transaction transaction) throws NxtException.ValidationException {
                ...
                if ((attachment.jsonIsPruned() || attachment.getData() == null) && AON.getEpochTime() - transaction.getTimestamp() < Constants.MIN_PRUNABLE_LIFETIME) {
                    throw new NxtException.NotCurrentlyValidException("Data has been pruned prematurely");
                }
                TransactionImpl uploadTransaction = TransactionDb.findTransaction(attachment.getTaggedDataId(), AON.getBlockchain().getHeight());
                ...
                if (taggedData != null && taggedData.getTransactionTimestamp() > AON.getEpochTime() + 6 * Constants.MIN_PRUNABLE_LIFETIME) {
