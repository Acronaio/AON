...
public final class Constants {
    ...
    public static final boolean isTestnet = AON.getBooleanProperty("aon.isTestnet");
    public static final boolean isOffline = AON.getBooleanProperty("aon.isOffline");
    public static final boolean isLightClient = AON.getBooleanProperty("aon.isLightClient");
    public static final String customLoginWarning = AON.getStringProperty("aon.customLoginWarning", null, false, "UTF-8");

    public static final int MAX_NUMBER_OF_TRANSACTIONS = 255;
    public static final int MIN_TRANSACTION_SIZE = 176;
    public static final int MAX_PAYLOAD_LENGTH = MAX_NUMBER_OF_TRANSACTIONS * MIN_TRANSACTION_SIZE;
    public static final long FEE_MULTIPLIER = 1 / 10; // Multiplier is then applied to ONE_AON constant, minimal fee is ONE_AON * FEE_MULTIPLIER
    public static final long MAX_BALANCE_AON = 21000000;
    public static final long ONE_AON = 100000000;
    public static final long MAX_BALANCE_NQT = MAX_BALANCE_AON * ONE_AON;
    public static final long INITIAL_BASE_TARGET = 7765428300L;//1553096460;
    public static final long MAX_BASE_TARGET = MAX_BALANCE_AON * INITIAL_BASE_TARGET;
    ...
    public static final int MAX_ROLLBACK = Math.max(AON.getIntProperty("aon.maxRollback"), 720);
    public static final int GUARANTEED_BALANCE_CONFIRMATIONS = isTestnet ? AON.getIntProperty("aon.testnetGuaranteedBalanceConfirmations", 1440) : 1440;
    public static final int LEASING_DELAY = isTestnet ? AON.getIntProperty("aon.testnetLeasingDelay", 1440) : 1440;
    public static final long MIN_FORGING_BALANCE_NQT = ONE_AON;

    public static final int MAX_TIMEDRIFT = 10000000; // allow up to 15 s clock difference
    public static final int FORGING_DELAY = AON.getIntProperty("aon.forgingDelay");
    public static final int FORGING_SPEEDUP = AON.getIntProperty("aon.forgingSpeedup");
    public static final int BATCH_COMMIT_SIZE = AON.getIntProperty("aon.batchCommitSize", Integer.MAX_VALUE);
    ...
    static {
        int maxPrunableLifetime = AON.getIntProperty("aon.maxPrunableLifetime");
        ENABLE_PRUNING = maxPrunableLifetime >= 0;
        MAX_PRUNABLE_LIFETIME = ENABLE_PRUNING ? Math.max(maxPrunableLifetime, MIN_PRUNABLE_LIFETIME) : Integer.MAX_VALUE;
    }
    public static final boolean INCLUDE_EXPIRED_PRUNABLE = AON.getBooleanProperty("aon.includeExpiredPrunable");
    ...
    public static final int LAST_KNOWN_BLOCK = -1;

    public static final int[] MIN_VERSION = new int[] {1, 11, 6};
    public static final int[] MIN_PROXY_VERSION = new int[] {1, 11, 6};

    static final long UNCONFIRMED_POOL_DEPOSIT_NQT = (isTestnet ? 50 : 100) * ONE_AON;
    public static final long SHUFFLING_DEPOSIT_NQT = (isTestnet ? 7 : 1000) * ONE_AON;

    public static final boolean correctInvalidFees = AON.getBooleanProperty("aon.correctInvalidFees");
