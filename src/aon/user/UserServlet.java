...
import static aon.user.JSONResponses.DENY_ACCESS;
import static aon.user.JSONResponses.INCORRECT_REQUEST;
import static aon.user.JSONResponses.POST_REQUIRED;
...
public final class UserServlet extends HttpServlet  {
    ...
    private static final boolean enforcePost = AON.getBooleanProperty("aon.uiServerEnforcePOST");
