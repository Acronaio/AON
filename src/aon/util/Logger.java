...
/**
 * Handle logging for the AON node server
 */
public final class Logger {
     ...
     * The aon/conf/logging-default.properties and aon/conf/logging.properties configuration
    ...
    static {
        ...
        System.setProperty("java.util.logging.manager", "aon.util.NxtLogManager");
        if (!(LogManager.getLogManager() instanceof NxtLogManager)) {
            System.setProperty("java.util.logging.manager",
                    (oldManager != null ? oldManager : "java.util.logging.LogManager"));
        }
        if (! Boolean.getBoolean("aon.doNotConfigureLogging")) {
            try {
                Properties loggingProperties = new Properties();
                AON.loadProperties(loggingProperties, "logging-default.properties", true);
                AON.loadProperties(loggingProperties, "logging.properties", false);
                AON.updateLogFileHandler(loggingProperties);
        ...
        log = org.slf4j.LoggerFactory.getLogger(AON.class);
        enableStackTraces = AON.getBooleanProperty("aon.enableStackTraces");
        enableLogTraceback = AON.getBooleanProperty("aon.enableLogTraceback");
