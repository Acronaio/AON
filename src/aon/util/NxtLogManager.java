...
/**
 * Java LogManager extension for use with AON
 */
public class NxtLogManager extends LogManager {
     ...
     * done terminating the AON processes.
     */
     ...
     * This allows us to continue to use logging facilities during AON shutdown.
     */
    @Override
    public void reset() {
    ...
    /**
     * AON shutdown is now complete, so call LogManager.reset() to terminate
     * the log handlers.
     */
    void nxtShutdown() {
        super.reset();
