...
public abstract class ShufflingTransaction extends TransactionType {
    ...
    private final static Fee SHUFFLING_PROCESSING_FEE = new Fee.ConstantFee(10 * Constants.ONE_AON * Constants.FEE_MULTIPLIER);
    private final static Fee SHUFFLING_RECIPIENTS_FEE = new Fee.ConstantFee(11 * Constants.ONE_AON * Constants.FEE_MULTIPLIER);
    ...
    public static final TransactionType SHUFFLING_REGISTRATION = new ShufflingTransaction() {
        ...
        void validateAttachment(Transaction transaction) throws NxtException.ValidationException {
            ...
            if (AON.getBlockchain().getHeight() + shuffling.getBlocksRemaining() <= attachment.getFinishValidationHeight(transaction)) {
    ...
    public static final TransactionType SHUFFLING_PROCESSING = new ShufflingTransaction() {
        ...
        void validateAttachment(Transaction transaction) throws NxtException.ValidationException {
            ...
            if (data == null && AON.getEpochTime() - transaction.getTimestamp() < Constants.MIN_PRUNABLE_LIFETIME) {
    ...
    public static final TransactionType SHUFFLING_CANCELLATION = new ShufflingTransaction() {
        ...
        void validateAttachment(Transaction transaction) throws NxtException.ValidationException {
            ...
            Transaction dataProcessingTransaction = TransactionDb.findTransactionByFullHash(participant.getDataTransactionFullHash(), AON.getBlockchain().getHeight());
