...
import aon.util.ReadWriteUpdateLock;
 ...
 *   CREATE ALIAS FTL_CREATE_INDEX FOR "aon.db.FullTextTrigger.createIndex"
 *       CALL FTL_CREATE(schema, table, columnList)
 *   CREATE ALIAS FTL_DROP_INDEX FOR "aon.db.FullTextTrigger.dropIndex"
 *       CALL FTL_DROP(schema, table)
 *   CREATE ALIAS FTL_SEARCH FOR "aon.db.FullTextTrigger.search"
 ...
 *   CREATE TRIGGER trigger_name AFTER INSERT,UPDATE,DELETE ON table_name FOR EACH ROW CALL "aon.db.FullTextTrigger"
 */
