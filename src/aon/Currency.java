...
public final class Currency {
    ...
    static {
        AON.getBlockchainProcessor().addListener(new CrowdFundingListener(), BlockchainProcessor.Event.AFTER_BLOCK_APPLY);
    }
    ...
    private Currency(Transaction transaction, Attachment.MonetarySystemCurrencyIssuance attachment) {
        ...
        this.creationHeight = AON.getBlockchain().getHeight();
