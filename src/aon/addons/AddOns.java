...
public final class AddOns {
    ...
    static {
        ...
        AON.getStringListProperty("aon.addOns").forEach(addOn -> {
            try {
        ...
        if (!addOns.isEmpty() && !AON.getBooleanProperty("aon.disableSecurityPolicy")) {
            System.setProperty("java.security.policy", AON.isDesktopApplicationEnabled() ? "nxtdesktop.policy" : "aon.policy");
