...
public class Snapshot implements AddOn {
    ...
    private static final int snapshotHeight = AON.getIntProperty("aon.snapshotHeight", Integer.MAX_VALUE);
    private static final boolean snapshotForTestnet = AON.getBooleanProperty("aon.snapshotForTestnet", true);
    ...
    public void init() {
        ...
        AON.getBlockchainProcessor().addListener(new Listener<Block>() {
            ...
            private Map<String, Long> exportIgnisBalances() {
                        ...
                        while (rs.next()) {
                            ...
                            if (snapshotForTestnet) {
                                eurSnapshotMap.put(account, BigInteger.valueOf(balance).multiply(BigInteger.valueOf(10000))
                                        .divide(BigInteger.valueOf(Constants.ONE_AON)).longValueExact());
                            } else {
                ...
                if (snapshotForTestnet && !developerPublicKeys.isEmpty()) {
                    ...
                    developerPublicKeys.forEach(publicKey -> {
                        ...
                        eurSnapshotMap.put(account, (developerBalance / Constants.ONE_AON) * 10000);
                    });
                }
            ...
            private boolean invalidCurrency(String code, String normalizedName) {
                ...
                if (code.contains("NXT") || code.contains("NEXT") || "aon".equals(normalizedName) || "next".equals(normalizedName)) {
                    return true;
                }
