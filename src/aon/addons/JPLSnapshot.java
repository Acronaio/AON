...
import aon.Account;
import aon.Block;
import aon.BlockchainProcessor;
import aon.Db;
import aon.FxtDistribution;
import aon.AON;
import aon.NxtException;
import aon.http.APIServlet;
import aon.http.APITag;
import aon.http.JSONResponses;
import aon.http.ParameterParser;
...
public final class JPLSnapshot implements AddOn {
     ...
     *
     * <p>This utility takes a snapshot of account balances and public keys on the AON blockchain as of the specified height,
     ...
     * <li>height - the AON blockchain height at which to take the snapshot</li>
     * </ul>
     *
     * <p>Response</p>
    ...
    public static class JPLSnapshotAPI extends APIServlet.APIRequestHandler {
        ...
        protected JSONStreamAware processRequest(HttpServletRequest request, HttpServletResponse response) throws NxtException {
            ...
            if (height <= 0 || height > AON.getBlockchain().getHeight()) {
            ...
            AON.getBlockchainProcessor().addListener(listener, BlockchainProcessor.Event.AFTER_BLOCK_ACCEPT);
            AON.getBlockchainProcessor().scan(height - 1, false);
            AON.getBlockchainProcessor().removeListener(listener, BlockchainProcessor.Event.AFTER_BLOCK_ACCEPT);
