...
public class DesktopSystemTray {
    ...
    void createAndShowGUI() {
        ...
        imageIcon = new ImageIcon("html/www/img/aon-icon-32x32.png", "tray icon");
        ...
        if (!AON.isDesktopApplicationEnabled()) {
    ...
    private void displayStatus() {
        ...
        addDataRow(statusPanel, "Application", AON.APPLICATION);
        addDataRow(statusPanel, "Version", AON.VERSION);
        ...
        addDataRow(statusPanel, "User folder", String.valueOf(Paths.get(AON.getUserHomeDir()).toAbsolutePath()));
        ...
        if (lastBlock != null) {
            ...
            addDataRow(statusPanel, "Seconds passed", String.valueOf(AON.getEpochTime() - lastBlock.getTimestamp()));
        ...
        addDataRow(statusPanel, "Process id", AON.getProcessId());
        addEmptyRow(statusPanel);
