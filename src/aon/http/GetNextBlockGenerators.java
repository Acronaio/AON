...
public final class GetNextBlockGenerators extends APIServlet.APIRequestHandler {
    ...
    protected JSONStreamAware processRequest(HttpServletRequest req) {
        ...
        if (block == null) {
            curBlock = AON.getBlockchain().getLastBlock();
        } else {
            try {
                curBlock = AON.getBlockchain().getBlock(Convert.parseUnsignedLong(block));
                if (curBlock == null) {
        ...
        */
        ...
        Block curBlock = AON.getBlockchain().getLastBlock();
