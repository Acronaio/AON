...
import aon.http.EventListener.PendingEvent;
 ...
 * aon.apiEventTimeout will be used if no timeout value is specified or
 * if the requested timeout is greater than aon.apiEventTimeout.</li>
 * </ul>
 *
