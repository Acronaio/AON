...
import static aon.http.JSONResponses.*;
...
public final class ParameterParser {
    ...
    public static double getDouble(HttpServletRequest req, String name, long min, long max,
                        boolean isMandatory) throws ParameterException {
        String paramValue = Convert.emptyToNull(req.getParameter(name));
        if (paramValue == null) {
            if (isMandatory) {
        ...
        try {
            ...
            throw new ParameterException(incorrect(name, String.format("value %s is not double", paramValue)));
        }
    }
    ...
    public static int getNumberOfConfirmations(HttpServletRequest req) throws ParameterException {
        return getInt(req, "numberOfConfirmations", 0, AON.getBlockchain().getHeight(), false);
    }
    ...
    public static Transaction.Builder parseTransaction(String transactionJSON, String transactionBytes, String prunableAttachmentJSON) throws ParameterException {
        ...
        if (transactionJSON != null) {
            try {
                ...
                return AON.newTransactionBuilder(json);
            ...
            try {
                ...
                return AON.newTransactionBuilder(bytes, prunableAttachments);
            } catch (NxtException.ValidationException|RuntimeException | ParseException e) {
                Logger.logDebugMessage(e.getMessage(), e);
                JSONObject response = new JSONObject();
