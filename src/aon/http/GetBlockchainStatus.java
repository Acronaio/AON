...
public final class GetBlockchainStatus extends APIServlet.APIRequestHandler {
    ...
    protected JSONObject processRequest(HttpServletRequest req) {
        ...
        response.put("application", AON.APPLICATION);
        ...
        BlockchainProcessor blockchainProcessor = AON.getBlockchainProcessor();
        ...
        response.put("currentMinRollbackHeight", AON.getBlockchainProcessor().getMinRollbackHeight());
