 ...
 * has not been received within aon.apiEventTimeout seconds.
 *
 * The maximum number of event users is specified by aon.apiMaxEventUsers.
 */
class EventListener implements Runnable, AsyncListener, TransactionalDb.TransactionCallback {

    /** Maximum event users */
    static final int maxEventUsers = AON.getIntProperty("aon.apiMaxEventUsers");

    /** Event registration timeout (seconds) */
    static final int eventTimeout = Math.max(AON.getIntProperty("aon.apiEventTimeout"), 15);

    /** Blockchain processor */
    static final BlockchainProcessor blockchainProcessor = AON.getBlockchainProcessor();

    /** Transaction processor */
    static final TransactionProcessor transactionProcessor = AON.getTransactionProcessor();
     ...
     *
     * AON event listeners will be added for the specified events
     *
     * @param   eventRegistrations      List of AON event registrations
     ...
     *
     * @param   eventRegistrations      AON event registrations
     * @throws  EventListenerException  Invalid AON event
     */
    ...
    private class NxtEventListener {
        ...
        /**
         * Add the AON listener for this event
         */
        ...
        /**
         * Remove the AON listener for this event
         */
        ...
        /**
         * Return the hash code for this AON event listener
         *
         * @return                  Hash code
         */
        @Override
        ...
        /**
         * Check if two AON events listeners are equal
         *
    ...
    static class EventRegistration {
         ...
         *
         * @param   event           AON listener event
        ...
        /**
         * Return the AON listener event
         *
         * @return                  AON listener event
         */
        public Enum<? extends Enum> getEvent() {
            return event;
        }
