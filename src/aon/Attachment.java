...
import static aon.util.bbh.LengthRwPrimitiveType.BYTE;
import static aon.util.bbh.LengthRwPrimitiveType.SHORT;
...
public interface Attachment extends Appendix {
    ...
    abstract class AbstractAttachment extends Appendix.AbstractAppendix implements Attachment {
        ...
        final int getFinishValidationHeight(Transaction transaction) {
            return isPhased(transaction) ? transaction.getPhasing().getFinishHeight() - 1 : AON.getBlockchain().getHeight();
        }
