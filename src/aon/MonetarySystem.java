...
public abstract class MonetarySystem extends TransactionType {
    ...
    public static final TransactionType CURRENCY_ISSUANCE = new MonetarySystem() {
        ...
        private final Fee FIVE_LETTER_CURRENCY_ISSUANCE_FEE = new Fee.ConstantFee(40 * Constants.ONE_AON * Constants.FEE_MULTIPLIER);
        private final Fee FOUR_LETTER_CURRENCY_ISSUANCE_FEE = new Fee.ConstantFee(1000 * Constants.ONE_AON * Constants.FEE_MULTIPLIER);
        private final Fee THREE_LETTER_CURRENCY_ISSUANCE_FEE = new Fee.ConstantFee(25000 * Constants.ONE_AON * Constants.FEE_MULTIPLIER);
        ...
        Fee getBaselineFee(Transaction transaction) {
            ...
            if (AON.getBlockchain().getHeight() < Constants.IGNIS_BLOCK && (Currency.getCurrencyByCode(attachment.getCode()) != null || Currency.getCurrencyByCode(attachment.getName()) != null
    ...
    public static final TransactionType RESERVE_INCREASE = new MonetarySystem() {
        ...
        void undoAttachmentUnconfirmed(Transaction transaction, Account senderAccount) {
            ...
            if (currency != null) {
                ...
                Transaction currencyIssuance = AON.getBlockchain().getTransaction(attachment.getCurrencyId());
