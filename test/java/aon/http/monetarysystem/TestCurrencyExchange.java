...
import aon.AccountCurrencyBalance;
import aon.BlockchainTest;
import aon.Constants;
import aon.CurrencyType;
...
public class TestCurrencyExchange extends BlockchainTest {
    ...
    public void buyCurrency() {
        ...
        Assert.assertEquals(new AccountCurrencyBalance(-1000*95 - Constants.ONE_AON, -Constants.ONE_AON, -500, 0),
        ...
        apiCall = new APICall.Builder("currencyBuy").
                secretPhrase(BOB.getSecretPhrase()).feeNQT(Constants.ONE_AON).
        ...
        Assert.assertEquals(new AccountCurrencyBalance(-200*105 - Constants.ONE_AON, -200*105 - Constants.ONE_AON, 200, 200),
    ...
    public void sellCurrency() {
        ...
        apiCall = new APICall.Builder("transferCurrency").
                secretPhrase(ALICE.getSecretPhrase()).feeNQT(Constants.ONE_AON).
                param("currency", currencyId).
        ...
        Assert.assertEquals(new AccountCurrencyBalance(-Constants.ONE_AON, -Constants.ONE_AON, -2000, -2000),
        ...
        Assert.assertEquals(new AccountCurrencyBalance(19000-Constants.ONE_AON, 19000-Constants.ONE_AON, -200, -200),
