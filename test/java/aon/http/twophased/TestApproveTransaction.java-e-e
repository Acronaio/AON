...
import aon.http.twophased.TestCreateTwoPhased.TwoPhasedMoneyTransferBuilder;
...
public class TestApproveTransaction extends BlockchainTest {
    ...
    public void validVoteCasting() {
        ...
        APICall apiCall = new TwoPhasedMoneyTransferBuilder()
                .finishHeight(AON.getBlockchain().getHeight() + duration)
                .build();
        ...
        Assert.assertEquals(-50 * Constants.ONE_AON - 2 * Constants.ONE_AON, ALICE.getBalanceDiff());
        Assert.assertEquals(50 * Constants.ONE_AON, BOB.getBalanceDiff());
    ...
    public void invalidVoteCasting() {
        ...
        Assert.assertEquals("ALICE balance: ", -2 * Constants.ONE_AON, ALICE.getBalanceDiff());
    ...
    public void sendMoneyPhasedNoVoting() {
        ...
        Assert.assertEquals(-100 * Constants.ONE_AON - fee, ALICE.getUnconfirmedBalanceDiff());
        // Recipient
        ...
        // Sender
        Assert.assertEquals(-100 * Constants.ONE_AON - fee, ALICE.getBalanceDiff());
        Assert.assertEquals(-100 * Constants.ONE_AON - fee, ALICE.getUnconfirmedBalanceDiff());
        // Recipient
