...
package aon.http.votingsystem;

import aon.BlockchainTest;
import aon.Constants;
import aon.AON;
import aon.VoteWeighting;
...
public class TestCreatePoll extends BlockchainTest {
    ...
    public void createInvalidPoll() {
        APICall apiCall = new CreatePollBuilder().minBalance(-Constants.ONE_AON).build();
    ...
    public static class CreatePollBuilder extends APICall.Builder {
        ...
        public CreatePollBuilder() {
            ...
            feeNQT(10 * Constants.ONE_AON);
            param("name", "Test1");
            param("description", "The most cool Beatles guy?");
            param("finishHeight", AON.getBlockchain().getHeight() + 100);
            ...
            param("minBalance", 10 * Constants.ONE_AON);
