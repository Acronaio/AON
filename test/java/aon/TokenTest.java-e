...
public class TokenTest extends BlockchainTest {
    ...
    public void testParseValidToken() throws Exception {
        ...
        Token actual = Token.parseToken(token, "http://aon.org");
    ...
    public void testGenerateToken() throws Exception {
        ...
        String tokenString = Token.generateToken("secret", "http://aon.org");
        int end = AON.getEpochTime();
        Token token = Token.parseToken(tokenString, "http://aon.org");
    ...
    public void emptySecret() throws Exception {
        String tokenString = Token.generateToken("", "http://aon.org");
        Token token = Token.parseToken(tokenString, "http://aon.org");
        assertTrue(token.isValid());
    }
